...
def soc_core_args(parser):
    ...
    # ROM parameters.
    soc_group.add_argument("--integrated-rom-size", default=0x230000, type=auto_int, help="Size/Enable the integrated (BIOS) ROM (Automatically resized to BIOS size when smaller).")
    ...
    # SRAM parameters.
    soc_group.add_argument("--integrated-sram-size", default=0x23000, type=auto_int, help="Size/Enable the integrated SRAM.")
