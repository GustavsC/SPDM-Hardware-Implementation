...
_io = [
    ...
    ("spisdcard", 0,
        ...
        Subsignal("clk",  Pins("AJ25"), IOStandard("LVCMOS18")),
        Subsignal("mosi", Pins("AJ26"), IOStandard("LVCMOS18")),
        Subsignal("cs_n", Pins("AL26"), IOStandard("LVCMOS18")),
        Subsignal("miso", Pins("AY29"), IOStandard("LVCMOS18")),
        Misc("SLEW=FAST"),
    ),
    
    ("sdcard", 0,
        Subsignal("rst",  Pins("BB12"), IOStandard("LVCMOS15"), Misc("VCCAUX_IO=NORMAL")),
        Subsignal("data", Pins("AY29 AM28 AL25 AL26"), IOStandard("LVCMOS18")),
        Subsignal("cmd",  Pins("AJ26"), IOStandard("LVCMOS18")),
        Subsignal("clk",  Pins("AJ25"), IOStandard("LVCMOS18")),
        Subsignal("cd",   Pins("AW35"), IOStandard("LVCMOS18")),
        Misc("SLEW=FAST"),
    ),
    ...
    # PCIe
     ("pcie_x4", 0,
        Subsignal("rst_n", Pins("AY35"), IOStandard("LVCMOS18")),
        Subsignal("clk_p", Pins("AB8")),
        Subsignal("clk_n", Pins("AB7")),
        Subsignal("rx_p",  Pins("W2 AA2 AC2 AE2")),
        Subsignal("rx_n",  Pins("W1 AA1 AC1 AE1")),
        Subsignal("tx_p",  Pins("Y4 AA6 AB4 AC6")),
        Subsignal("tx_n",  Pins("Y3 AA5 AB3 AC5")),
    ),
    ...
    ("pcie_x8", 0,
        ...
        Subsignal("clk_p", Pins("AB8")),
        Subsignal("clk_n", Pins("AB7")),
        Subsignal("rx_p",  Pins("W2 AA2 AC2 AE2 AG2 AH4 AJ2 AK4")),
        Subsignal("rx_n",  Pins("W1 AA1 AC1 AE1 AG1 AH3 AJ1 AK3")),
        Subsignal("tx_p",  Pins("Y4 AA6 AB4 AC6 AD4 AE6 AF4 AG6")),
        Subsignal("tx_n",  Pins("Y3 AA5 AB3 AC5 AD3 AE5 AF3 AG5")),
    ),
